...
4.What query would you run to get  all the customers in store_id = 1
 and inside these cities (1, 42, 312 and 459)? Your query should 
...
and "special feature = behind the scenes",  joined by actor_id = 15?
 ...
 rate and special feature. (Hint: You may use LIKE function in 
 getting the 'behind the scenes' part).
*/
################################################
-- WHAT IS THE DIFFERENCE BETWEEN  "rating = G" 
-- and "special feature = behind the scenes",
-- WHY rating=G WHY 
-- WHYAND film.special_features 
...
the film_id = 369? Your query should return the first_name, 
last name and last_update of the actors.
*/
...
/*
7.What query would you run to get all drama films with a rental 
rate of 2.99 ? Your query should return film title, description,
...
/*
8.What query would you run to get all the action films that joined by SANDRA KILMER. 
...
*/################################################
why not actor.first_name,actor.last_name
why genre
################################################
